...
Organizações sem vínculo formal com a RIT também podem usar a plataforma. Para isso, entre em contato pelo formulário em [rit360.org.br/interesse](https://rit360.org.br/interesse): a partir desse contato, a RIT e a organização acertam as condições de uso, incluindo a eventual contrapartida financeira. Estes Termos não fixam valor — vale para cada organização o que estiver acordado com ela.

Quando houver contrapartida financeira acordada, o pagamento deve ser realizado antecipadamente ao período de uso, e a inadimplência por mais de 30 (trinta) dias corridos pode resultar na suspensão do acesso.

### 4.3 Alterações de preço

A RIT poderá alterar os valores acordados mediante comunicação com antecedência mínima de 30 (trinta) dias, por e-mail ou aviso na plataforma. A continuidade do uso após a data de vigência do novo valor implica aceite da alteração.
...
A RIT poderá atualizar estes Termos periodicamente. Quando houver alterações relevantes, comunicamos por e-mail ou por aviso na plataforma. A versão vigente estará sempre disponível nesta página, com a data de vigência indicada no topo, de modo que você pode consultar a qualquer momento o que está valendo e desde quando. Cada versão é preservada em um endereço próprio e imutável, para fins de auditoria; quando a mudança for material, a plataforma pode solicitar o **novo aceite** dos Termos no próximo acesso. A continuidade do uso após a data de vigência das alterações implica aceite dos novos Termos.
